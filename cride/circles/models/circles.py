...
class Circle(CRideModel):
    ...
    A circle is a private group where rides are offered and taken by its members.
    To join a circle a user must receive a unique invitation code from an existing
    circle member.
    """
    ...
    is_limited = models.BooleanField(
        'limited',
        default=False,
        help_text='limited circles can grow to a certain amount of members'
    )
